...
import { seatColumn, seatRowNum, groupForCol, getZoneForSeat } from "../utils/seatHelpers";
import {
...
import {
  ...
  computePrivacyRefundTHB,        // ✅ keep this
} from "../utils/pricingConstants"; // ✅ removed MARKUP_PER_ZONE_THB

export default function PassengerBookingUpdateSeat() {
  const [lang, setLang] = useState("EN");
  const t = STR[lang];

  // toggle prices on the tiles
  ...
  // ----- Derived values for current passenger -----
  const currentSeat = assignments[selectedPassengerId] || "";

  // zone + pricing for current passenger
  ...
  // Eligible privacy seats are side seats in the same block, not already booked
