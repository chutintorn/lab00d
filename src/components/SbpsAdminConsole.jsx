...
const STEPS = [
  { n: 1, title: "Customer books Anchor Seat", body: "Customer selects a primary seat. This seat anchors the SBPS offer logic; neighbor seats become candidates for privacy blocks.", pill: { text: "Anchor", tone: "info" } },
